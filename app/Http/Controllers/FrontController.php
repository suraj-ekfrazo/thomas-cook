...
//        exit;
                ...
                if ($incideantCreated) {
                    ...
                    if ($request->BuySell == 1) {
                        if ($request->documentStatus == 1) {
                            ...
                            else if ($request->traveltype == 7) {
                                //Travel type Others
                                $this->sellOthersDocumentUpload($request, $viewNumber, $request->agentCodeDetails);
                            }
	...
	$customerArray['created_at'] = date('Y-m-d h:i:s');
     ...
     /***********************************************************
    Sell-WithDocument-Others
    - Document upload by agent sell and medical and document type with
     ************************************************************/
    function sellOthersDocumentUpload($request, $inci_number, $default_agent_code = '')
    {
         //echo $inci_number."==>".$default_agent_code;
        date_default_timezone_set('Asia/Kolkata');
        $customerArray = array();
