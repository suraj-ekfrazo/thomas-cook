    ...
    public function uploadDocument(Request $request)
    {
        ...
        if ((strtotime(date('H:i:s')) > strtotime('10:00:00') && strtotime(date('H:i:s')) < strtotime('23:50:00')))
        {
            ...
            DB::table('incidents')
                ...
                ->update(array('inci_passport_number'=>$passport_number,'upload_doc_comment'=>$request->upload_doc_comment,'inci_recived_date'=>date('Y-m-d'),'inci_recived_time'=>date('H:i:s'),'updated_at' => null));
            //get random tcuser
