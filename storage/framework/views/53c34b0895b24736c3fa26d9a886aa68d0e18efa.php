    ...
    <div class="container">
        ...
        <div class="row pt-5 pb-5 justify-content-center">
            <!-- <div class="col-md-3 col-lg-3 col-sm-3">
                    <a href="<?php echo e(route('admin-incidents.index')); ?>">
                        <div class="widget-stat card bg-dashboard m-3 <?php if(request()->segment(1) == 'admin-incidents' && request()->segment(2) == ''): ?> active <?php endif; ?> ">
                            <div class="card-body ">
                                <div class="media">
                                    <span class="me-3">
        ...
        <div class="table-responsive table-striped p-3 mb-3 mt-3 bg-white shadow rounded-5">
            <div class="d-flex justify-content mb-4">
                ...
                <div class="ps-1 fw-bold" style="color: #1E1E1E;">Sell Report </div>
                <div id="buttons"></div>
...
<?php echo $__env->make('stacks.js.modules.admin-incidents.sell-report', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dataseed/prod-thomascook.dataseedtech.com/Modules/AdminIncidents/Resources/views/modal/sell-report.blade.php ENDPATH**/ ?>