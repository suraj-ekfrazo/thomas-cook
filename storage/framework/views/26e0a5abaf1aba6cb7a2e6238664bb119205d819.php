<script>
    $(function() {
                ...
                },
		{
            ...
            dataTable = callDataTable('data-datatable', '<?php echo route('booking-allocation.data'); ?>', filters, columns, '', '',
                columnDefs);
    ...
    $(document).on('change', '#tcUserName', function() {
        ...
        $.ajax({
            url: "<?php echo e(route('booking-allocation.update-assigned-user')); ?>",
            type: 'POST',
            data: {
                'tcuser_id': tcuser_id,
...
<?php /**PATH /home/dataseed/prod-thomascook.dataseedtech.com/resources/views/stacks/js/modules/booking-allocation/index.blade.php ENDPATH**/ ?>