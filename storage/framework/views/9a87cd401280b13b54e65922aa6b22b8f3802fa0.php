<script>
    $(function() {
        var loginuser='<?php echo auth()->user()->id; ?>';
        var envdata='<?php echo e(env('TC_USER_ID')); ?>';
        //console.log(envdata);
        var
            filters = {
                search: "",
                ...
                },
		{
                    ...
                    render: function(data, type, full, meta) {
                        if(loginuser==envdata){
                            ...
                            var url = '<?php echo e(route("tcuser.booking-request", ":id")); ?>';
	    ...
	    rowCallback = function (row, data) {
            ...
            dataTable = callDataTable('data-datatable', '<?php echo route('tcuser.bookingRequest'); ?>', filters, columns, '', '', columnDefs, '', rowCallback);
    });

</script>
<?php /**PATH /home/dataseed/prod-thomascook.dataseedtech.com/resources/views/stacks/js/tcuser-dashboard.blade.php ENDPATH**/ ?>