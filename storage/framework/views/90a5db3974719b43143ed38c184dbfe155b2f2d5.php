<script>
    $(function() {
	    ...
	    dataTable = callDataTable('data-datatable', '<?php echo route('admin-incidents.buy-report'); ?>', filters, columns, '', '',
                columnDefs);
    ...
    function exportExcel() {
        ...
        $.ajax({
            url: "<?php echo route('admin-incidents.export-buy-report'); ?>",
            type: 'POST',
...
<?php /**PATH /home/dataseed/prod-thomascook.dataseedtech.com/resources/views/stacks/js/modules/admin-incidents/buy-report.blade.php ENDPATH**/ ?>