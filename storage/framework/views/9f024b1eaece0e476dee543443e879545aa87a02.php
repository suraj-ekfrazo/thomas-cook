        ...
        <div class="tab-content" id="ex3-content">
			...
			<input type="hidden" value="" name="buyfixRate" id="buyfixRate">
                        ...
                        <input type="hidden" id="agentCodeDetails" name="agentCodeDetails"
                               value="<?php echo e($AgentData->agent_code); ?>">
                        <input type="hidden" id="agentCode" name="agentCode" value="<?php echo e($AgentData->agent_code); ?>">
                        <input type="hidden" value="<?php echo e($AgentData->agent_buy); ?>" name="agentBuy" id="agentBuy">
                        <input type="hidden" value="<?php echo e($AgentData->agent_sell); ?>" name="agentSell" id="agentSell">
            ...
            <div class="tab-pane fade bg-light" id="ex3-tabs-2" role="tabpanel" aria-labelledby="ex3-tab-2">
			    ...
			    <th style="color: #2565ab; font-weight: 800;  ">Date</th>
                        ...
                        <?php if(isset($AgentWithoutDocIncident) && count($AgentWithoutDocIncident)>0): ?>
			
                            <?php $count= 1 ?>
                            <?php $__currentLoopData = $AgentWithoutDocIncident; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inci_without_doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php
                                    ...
                                    $ic_currency_rate = '';
                                ?>
                                <?php $__currentLoopData = $inci_without_doc->incidentCurrency; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inci_currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($inci_without_doc->inci_number); ?></td>
                                    <td>
                                    ...
                                    <td><?php echo e($inci_without_doc->inci_forex_card_no); ?></td>
									 <td><?php echo e($inci_without_doc->inci_passport_number); ?></td>
                                    <td><?= $ic_frgn_curr_amount ?></td>
				    <td><?= $ic_currency_rate ?></td>
                                    <td><?= $ic_inr_amount ?></td>
				    <td><?php echo e($inci_without_doc->inci_create_time); ?></td>		
                                    <td>
                                        <?php
                                            $assign_status = '';
                                            $color = '';
                                            $badge_color = '';
                                        ?>
                                        <?php if($inci_without_doc->inci_status == '3'): ?>
                                            <?php
                                                $assign_status = 'Under Process';
                                                $color = '#FF9E2E';
                                                $badge_color = 'badge-warning';
                                            ?>
                                        <?php elseif($inci_without_doc->inci_status == '2'): ?>
                                            <?php
                                                $assign_status = 'Expired';
                                                $color = '#2999bd';
                                                $badge_color = 'badge-info';
                                            ?>
                                        <?php elseif($inci_without_doc->inci_status == '1'): ?>
                                            <?php
                                                $assign_status = 'Accepted';
                                                $color = '#0F9500';
                                                $badge_color = 'badge-success';
                                            ?>
                                        <?php elseif($inci_without_doc->inci_status == '0'): ?>
                                            <?php
                                    ...
                                    <td>
                                        <a href="javascript:void(0)" data-id="<?php echo e($inci_without_doc->inci_number); ?>"
                                           id="<?php echo e($inci_without_doc->inci_number); ?>"
            ...
            <div class="tab-pane fade" id="ex3-tabs-3" role="tabpanel" aria-labelledby="ex3-tab-3">
			    ...
			    <th style="color: #2565ab; font-weight: 800;  ">Date</th>
                        ...
                        <?php if($AgentIncidentDetail): ?>
                            <?php $count= 1 ?>
                            <?php $__currentLoopData = $AgentIncidentDetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agentInci): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				    ...
				    $inci_create_time = '';
                                ?>
                                <?php $__currentLoopData = $agentInci->incidentCurrency; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agent_inci_currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                ...
                                <tr>
                                    <td><?php echo e($count++); ?></td>
                                    <td><?php echo e($agentInci->inci_number); ?></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                    ...
                                    <td><?php echo e($agentInci->inci_forex_card_no); ?></td>
					<td><?php echo e($agentInci->inci_passport_number); ?></td>
                                    <td><?= $inci_frgn_curr_amount ?></td>
				    <td><?= $inci_currency_rate ?></td>
                                    <td><?= $inci_inr_amount ?></td>
			   	    <td><?php echo e(date('d-m-Y H:i:s', strtotime($agentInci->inci_create_time))); ?></td>
                                    <td>
                                        <?php
                                            $assign_status = '';
                                            $color = '';
                                            $badge_color = '';
                                        ?>
                                        <?php if($agentInci->inci_status == '3'): ?>
                                            <?php
                                                $assign_status = 'Under Process';
                                                $color = '#FF9E2E';
                                                $badge_color = 'badge-warning';
                                            ?>
                                        <?php elseif($agentInci->inci_status == '2'): ?>
                                            <?php
                                                $assign_status = 'Expired';
                                                $color = '#2999bd';
                                                $badge_color = 'badge-info';
                                            ?>
                                        <?php elseif($agentInci->inci_status == '1'): ?>
                                            <?php
                                                $assign_status = 'Accepted';
                                                $color = '#0F9500';
                                                $badge_color = 'badge-success';
                                            ?>
                                        <?php elseif($agentInci->inci_status == '0'): ?>
                                            <?php
                                                $assign_status = 'Rejected';
                                                $color = '#EC0000';
                                                $badge_color = 'badge-danger';
                                    ...
                                    <td>
                                        <?php if($agentInci->inci_status == '0'): ?>
                                            <a href="javascript:void(0)" data-id="<?php echo e($agentInci->inci_number); ?>"
                                               id="rejected_<?php echo e($agentInci->inci_number); ?>"
                                               class="fw-bold uploadRejectedDoc">Upload
                                            </a>
					<?php else: ?>
                                            <a href="javascript:void(0)" data-id="<?php echo e($agentInci->inci_number); ?>"
                                               id="view_<?php echo e($agentInci->inci_number); ?>"
...
<?php $__env->startPush('pagescript'); ?>
    ...
    <script>
        ...
        $(document).on('click', '.btn-close', function () {
            ...
            $(document).on('click', '.uploadDoc', function () {
                ...
                $.ajax({
                    type: "GET",
                    url: "<?php echo e(route('agent-view-upload-document')); ?>",
                    data: {
                        inci_id: inci_id,
                    },
        ...
        $(document).on('click', '.uploadRejectedDoc', function () {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo e(route('agent-view-rej-upload-doc')); ?>",
                data: {
                    inci_id: inci_id,
                },
                success: function (result) {
	...
	//View doc modal
        $(document).on('click', '.viewDoc', function () {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('agent-view-document')); ?>",
                data: {
                    inci_id: inci_id,
                },
                success: function (result) {
   ...
   var inrCalculation = ( parseFloat(currencyRate) * amount );
        ...
        var getBuyAndSellMargin = "<?php echo e(url('getBuyAndSellMargin')); ?>";
 ...
 console.log("else");
		...
		comment: "required",
            ...
            submitHandler: function (form) {
                ...
                setTimeout(() => { 
                    $.ajax({
                        url: "<?php echo e(url('incidentInsert')); ?>",
                        type: 'POST',
                        async: false,
...
<?php echo $__env->make('layouts.agent.appmain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dataseed/prod-thomascook.dataseedtech.com/resources/views/agents-dashboard.blade.php ENDPATH**/ ?>