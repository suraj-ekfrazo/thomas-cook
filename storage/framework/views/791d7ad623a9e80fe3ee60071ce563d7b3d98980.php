<?php $__env->startSection('content'); ?>
    ...
    <div style="background-image: url(<?php echo e(asset('admin-assets/img/main_bg.jpg')); ?>);">
        <div class="container">
            ...
            <!--End sub heading -->
			 <a class="btn btn-warning" href="<?php echo e(route('export.tcuser')); ?>">Export Agent Data</a>
    ...
    <?php $__env->startPush('pagescript'); ?>
        ...
        <?php echo $__env->make('stacks.js.modules.agent.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dataseed/prod-thomascook.dataseedtech.com/Modules/Agent/Resources/views/index.blade.php ENDPATH**/ ?>