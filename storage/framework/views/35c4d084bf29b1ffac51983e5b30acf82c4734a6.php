<script>
    $(function() {
	    ...
	    dataTable = callDataTable('data-datatable', '<?php echo route('admin-incidents.agent-report'); ?>', filters, columns, '', '',
                columnDefs);
    ...
    function exportExcel() {
        ...
        $.ajax({
            url: "<?php echo route('admin-incidents.export-agent-report'); ?>",
            type: 'POST',
...
<?php /**PATH /home/dataseed/prod-thomascook.dataseedtech.com/resources/views/stacks/js/modules/admin-incidents/agent-report.blade.php ENDPATH**/ ?>