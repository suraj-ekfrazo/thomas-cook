<script>
    $(function() {
	    ...
	    columns = [
            ...
            dataTable = callDataTable('data-datatable', '<?php echo route('under-process-request.data-sell'); ?>', filters, columns, '', '',
                columnDefs);
    ...
    function exportExcel() {
        ...
        $.ajax({
            url: "<?php echo route('under-process-request.sellexport'); ?>",
            type: 'POST',
...
<?php /**PATH /home/dataseed/prod-thomascook.dataseedtech.com/resources/views/stacks/js/modules/under-process-booking-req/sell-data.blade.php ENDPATH**/ ?>