<?php $__env->startSection('content'); ?>
        ...
        <div class="container">
            ...
            <div class="table-responsive table-striped p-3 mb-3 mt-3 bg-white shadow rounded-5">
                <div class="d-flex justify-content mb-4">
                    ...
                    <div class="ps-1 fw-bold" style="color: #1E1E1E;">Rate Master
                    </div>
                </div>
                <table id="data-datatable" class="table roundedTable table w-100 nowrap">
                    <thead style="backgrounD-color: #F4F6F8;">
                        <tr>
                            ...
                            <th style="color: #2565ab; font-weight: 800;  ">Buy Margin</th>
                            
                            <th style="color: #2565ab; font-weight: 800;  ">sell margin 10-12</th>
                            <th style="color: #2565ab; font-weight: 800;  ">sell margin 12-2</th>
                            <th style="color: #2565ab; font-weight: 800;  ">sell margin 2-3:30</th>
                            <th style="color: #2565ab; font-weight: 800;  ">sell margin 3:30 end</th>
			    <th style="color: #2565ab; font-weight: 800;  ">Current Rate</th>
			    <th style="color: #2565ab; font-weight: 800;  ">Holiday Margin</th>
    ...
    <?php $__env->startPush('pagescript'); ?>
        ...
        <?php echo $__env->make('stacks.js.modules.rate-master.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dataseed/prod-thomascook.dataseedtech.com/Modules/RateMaster/Resources/views/index.blade.php ENDPATH**/ ?>