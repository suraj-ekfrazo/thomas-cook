<script>
    $(function() {
        var
            ...
            dataTable = callDataTable('data-datatable', '<?php echo route('tcuser.data'); ?>', filters, columns, '', '',
                columnDefs);
    ...
    $(document).on('change', '.switch-input ', function() {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                $.ajax({
                    url: "<?php echo e(route('tcuser.update-status')); ?>",
                    type: 'GET',
                    data: {
                        'status': status,
                        'id': id
...
<?php /**PATH /home/dataseed/prod-thomascook.dataseedtech.com/resources/views/stacks/js/modules/tcuser/index.blade.php ENDPATH**/ ?>