<?php $__env->startSection('content'); ?>
	...
	<?php if(auth()->user()->getRoleNames()[0] != 'Sub Admin'): ?>
                    ...
                    <a href="<?php echo e(route('admin-incidents.report-summary')); ?>">
                        <div class="widget-stat card bg-dashboard m-3">
                            <div class="card-body ">
                                <div class="media">
                                    <span class="me-3">
                                        <img src="<?php echo e(asset('admin-assets/svg/dashboard/ic_report.svg')); ?>">
                                    </span>
                    ...
                    <a href="#">
                        <div class="widget-stat card bg-dashboard m-3">
                            <div class="card-body ">
                                <div class="media">
                                    <span class="me-3">
                                        <img src="<?php echo e(asset('admin-assets/svg/dashboard/ic_automation_report.svg')); ?>">
                                    </span>
                ...
                <div class="col-md-6 col-lg-4 col-sm-12">
                    <a href="<?php echo e(route('booking-allocation')); ?>">
                        <div class="widget-stat card bg-dashboard m-3">
                            <div class="card-body ">
                                <div class="media">
                                    <span class="me-3">
                                        <img src="<?php echo e(asset('admin-assets/svg/dashboard/ic_booking_allocation.svg')); ?>">
                                    </span>
		...
		<?php endif; ?>
                <div class="col-md-6 col-lg-4 col-sm-12">
                    <a href="<?php echo e(route('admin-incident-requests.index')); ?>">
                        <div class="widget-stat card bg-dashboard m-3">
                            <div class="card-body ">
                                <div class="media">
                                    <span class="me-3">
                                        <img src="<?php echo e(asset('admin-assets/svg/dashboard/ic_view_request.svg')); ?>">
                                    </span>
		...
		<?php if(auth()->user()->getRoleNames()[0] != 'Sub Admin'): ?>
                ...
                <div class="col-md-6 col-lg-4 col-sm-12">
                    <a href="<?php echo e(route('under-process-request.index')); ?>">
                        <div class="widget-stat card bg-dashboard m-3">
                            <div class="card-body ">
                                <div class="media">
                                    <span class="me-3">
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dataseed/prod-thomascook.dataseedtech.com/resources/views/welcome.blade.php ENDPATH**/ ?>