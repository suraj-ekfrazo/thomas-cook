        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row mt-3 bgc m-2">
                    <div class="col-lg-12 col-sm-12 mt-3">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="currency_name" id="currency_name"
                                ...
                                value="<?php echo e($data->currency_name); ?>" readonly>
                    ...
                    <div class="col-lg-6 col-sm-6 mt-3 <?php echo e($errors->has('sell_margin_10_12') ? 'has-error' : ''); ?>">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="sell_margin_10_12" id="sell_margin_10_12"
                                class="form-control border-0 border-bottom bg-transparent"
                                placeholder="Enter Sell Margin" value="<?php echo e($data->sell_margin_10_12); ?>">
                            <?php $__env->startComponent('components.ajax-error', ['field' => 'sell_margin_10_12']); ?>
                            <?php echo $__env->renderComponent(); ?>
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-6 mt-3 <?php echo e($errors->has('sell_margin_12_2') ? 'has-error' : ''); ?>">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="sell_margin_12_2" id="sell_margin_12_2"
                                class="form-control border-0 border-bottom bg-transparent"
                                placeholder="Enter Sell Margin" value="<?php echo e($data->sell_margin_12_2); ?>">
                            <?php $__env->startComponent('components.ajax-error', ['field' => 'sell_margin_12_2']); ?>
                            <?php echo $__env->renderComponent(); ?>
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-6 mt-3 <?php echo e($errors->has('sell_margin_2_3_30') ? 'has-error' : ''); ?>">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="sell_margin_2_3_30" id="sell_margin_2_3_30"
                                class="form-control border-0 border-bottom bg-transparent"
                                placeholder="Enter Sell Margin" value="<?php echo e($data->sell_margin_2_3_30); ?>">
                            <?php $__env->startComponent('components.ajax-error', ['field' => 'sell_margin_2_3_30']); ?>
                            <?php echo $__env->renderComponent(); ?>
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-6 mt-3 <?php echo e($errors->has('sell_margin_3_30_end') ? 'has-error' : ''); ?>">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="sell_margin_3_30_end" id="sell_margin_3_30_end"
                                class="form-control border-0 border-bottom bg-transparent"
                                placeholder="Enter Sell Margin" value="<?php echo e($data->sell_margin_3_30_end); ?>">
                            <?php $__env->startComponent('components.ajax-error', ['field' => 'sell_margin_3_30_end']); ?>
                            <?php echo $__env->renderComponent(); ?>
                        </div>
                    </div>
		    <div class="col-lg-6 col-sm-6 mt-3 <?php echo e($errors->has('buy_margin') ? 'has-error' : ''); ?>">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="buy_margin" id="buy_margin"
                                class="form-control border-0 border-bottom bg-transparent"
                                placeholder="Enter Buy Margin" value="<?php echo e($data->buy_margin); ?>">
                            <?php $__env->startComponent('components.ajax-error', ['field' => 'buy_margin']); ?>
                            <?php echo $__env->renderComponent(); ?>
                        </div>
                    </div>
			 <div class="col-lg-6 col-sm-6 mt-3 <?php echo e($errors->has('holiday_margin') ? 'has-error' : ''); ?>">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="holiday_margin" id="holiday_margin"
                                   class="form-control border-0 border-bottom bg-transparent"
                                   placeholder="Enter Buy Margin" value="<?php echo e($data->holiday_margin); ?>">
                            <?php $__env->startComponent('components.ajax-error', ['field' => 'holiday_margin']); ?>
                            <?php echo $__env->renderComponent(); ?>
                        </div>
                    </div>
...
<?php /**PATH /home/dataseed/prod-thomascook.dataseedtech.com/Modules/RateMaster/Resources/views/modal/edit.blade.php ENDPATH**/ ?>