        ...
        var
            ...
            columnDefs = [{
                ...
                },
                {
                    "targets": [7],
                    render: function(data, type, full, meta) {
                        var parentData = full.parent;
                        if (parentData != null) {
                            return '<a href="javascript: void(0);" onclick="openViewModal(' + parentData
                                .id + ')">' + parentData.agent_code + '</i></a>';
                        }
                        return '';
                    }
                },
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        return '<a href="javascript: void(0);" onclick="openEditModal(' + id +
                            ')" type="button" title="Edit" class="svg-bg m-0" style="background-color: rgba(37,101,171,0.14); color:#2565ab"><i class="fa-solid fa-pen" style="font-size: 14px;"> </i></a>' +
            ...
            dataTable = callDataTable('data-datatable', "<?php echo route('subagent.data'); ?>", filters, columns, '', '',
                columnDefs);
    ...
    $(document).on('change', '.switch-input', function() {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                $.ajax({
                    url: "<?php echo e(route('subagent.update-status')); ?>",
                    type: 'GET',
                    data: {
                        'status': status,
                        'id': id
...
</script><?php /**PATH /home/dataseed/prod-thomascook.dataseedtech.com/resources/views/stacks/js/modules/sub-agent/index.blade.php ENDPATH**/ ?>