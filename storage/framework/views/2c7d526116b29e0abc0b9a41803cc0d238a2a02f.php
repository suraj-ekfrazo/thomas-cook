<?php $__env->startSection('content'); ?>
    <div class="position-absolute top-0 start-50 translate-middle-x ">
        ...
        <!-- <img src="<?php echo e(asset('assets/images/LOGO.png')); ?>" class="logo-img"> -->
    </div>
    <div class="wrapper-3">
        <div class="inner">
...
if (isset($messageCache)) { $message = $messageCache; }
                    ...
                    <div class="mt-4" style="font-size: 14px; text-align:center;">
                        <p class="text-dark">
                            ...
                            &nbsp;&nbsp;&nbsp;Back To<a href="<?php echo e(url('/agent/login')); ?>"
...
<?php echo $__env->make('layouts.agent.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dataseed/prod-thomascook.dataseedtech.com/resources/views/agent/passwords/email.blade.php ENDPATH**/ ?>