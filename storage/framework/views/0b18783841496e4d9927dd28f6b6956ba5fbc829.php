<div class="row mt-3 bgc m-2">
    ...
    <div class="col-lg-12 col-sm-12 mt-3">
	 ...
	 <?php if(isset($selldata->passport_status) && ($selldata->passport_status == 2 || $selldata->passport_status == 3 )): ?>
        <!-- <div class="col-md-12">
        ...
        <p class="text-danger"><?php echo e($selldata->passport_comment); ?></p> -->
        <div class="col-md-12">
        <div class="form-attach-file border-bottom border-top pt-1 pb-1 mt-1 ">
            <label class="form-attach-label row mb-1" for="passport2">
                <div class="text-dark fw-bold">Passport
                    <?php if($selldata->passport_status == 2): ?>
    ...
    <p class="text-danger"><?php echo e($selldata->passport_comment); ?></p>
    <?php endif; ?>
    <?php if(isset($selldata->visa_status) && ($selldata->visa_status == 2 || $selldata->visa_status == 3) &&
        ...
        <p class="text-danger"><?php echo e($selldata->visa_comment); ?></p> -->
        <div class="col-md-12">
        <div class="form-attach-file border-bottom border-top pt-1 pb-1 mt-1 ">
            <label class="form-attach-label row mb-1" for="visa2">
                <div class="text-dark fw-bold">Visa

                    <?php if($selldata->visa_status == 2): ?>
                        <span class="text-danger">*</span>
                    <?php endif; ?>
    ...
    <?php if(isset($selldata->ticket_status) && ($selldata->ticket_status == 2 || $selldata->ticket_status == 3) &&
        ($travel_type == 1 || $travel_type == 3 || $travel_type == 4 || $travel_type == 5)): ?>
	    <!-- <div class="col-md-12">
            <div class="form-attach-file border-top pt-1 pb-1">
        ...
        <p class="text-danger"><?php echo e($selldata->ticket_comment); ?></p> -->
        <div class="col-md-12">
        <div class="form-attach-file border-bottom border-top pt-1 pb-1 mt-1 ">
    ...
    <?php if(isset($selldata->pan_card_status) && ($selldata->pan_card_status == 2 || $selldata->pan_card_status == 3)): ?>
    <div class="col-md-12">
        <div class="form-attach-file border-bottom border-top pt-1 pb-1 mt-1 ">
            <label class="form-attach-label row mb-1" for="pan2">
                <div class="text-dark fw-bold">PAN

                    <?php if($selldata->pan_card_status == 2): ?>
                        <span class="text-danger">*</span>
                    <?php endif; ?>
    ...
    <p class="text-danger"><?php echo e($selldata->pan_card_comment); ?></p>
    <?php endif; ?>

    <?php if(isset($selldata->apply_status) && ($selldata->apply_status == 2 || $selldata->apply_status == 3)): ?>
        <!-- <div class="col-md-12">
            <div class="form-attach-file border-top pt-1 pb-1">
        ...
        <div class="form-attach-file border-bottom border-top pt-1 pb-1 mt-1 ">
            <label class="form-attach-label row mb-1" for="application2">
                <div class="text-dark fw-bold">Application
                    ...
                    <?php if($selldata->apply_status == 2): ?>
                        <span class="text-danger">*</span>
                    <?php endif; ?>
        ...
        <p class="text-danger"><?php echo e($selldata->apply_comment); ?></p>
    <?php endif; ?>
    <?php 
    
        
    ?>
    <?php if(isset($selldata->annex_status) && ($selldata->annex_status == 2 || $selldata->annex_status == 3)): ?>
        <!-- <div class="col-md-12">
            <div class="form-attach-file border-top pt-1 pb-1 ">
        ...
        <div class="form-attach-file border-bottom border-top pt-1 pb-1 mt-1 ">
            <label class="form-attach-label row mb-1" for="annexure2">
                <div class="text-dark fw-bold">Annexure
                    ...
                    <?php if($selldata->annex_status == 2): ?>
                        <span class="text-danger">*</span>
                    <?php endif; ?>
        ...
        <p class="text-danger"><?php echo e($selldata->annex_comment); ?></p>
    <?php endif; ?>
      <?php if(isset($selldata->bank_transfer_status) && ($selldata->bank_transfer_status == 2 || $selldata->bank_transfer_status == 3)): ?>
        <!-- <div class="col-md-12">
            <div class="form-attach-file border-top pt-1 pb-1">
        ...
        <div class="form-attach-file border-bottom border-top pt-1 pb-1 mt-1 ">
            <label class="form-attach-label row mb-1" for="banktransfer2">
                <div class="text-dark fw-bold">Bank Transfer Copy
                    ...
                    <?php if($selldata->bank_transfer_status == 2): ?>
                        <span class="text-danger">*</span>
                    <?php endif; ?>
        ...
        <p class="text-danger"><?php echo e($selldata->bank_transfer_comment); ?></p>
    <?php endif; ?>

    <?php if(isset($selldata->sof_status) && ($selldata->sof_status == 2 || $selldata->sof_status == 3) &&
        ($travel_type == 1 || $travel_type == 3 || $travel_type == 4 || $travel_type == 5)): ?>
        <!-- <div class="col-md-12">
            <div class="form-attach-file border-top pt-1 pb-1">
        ...
        <p class="text-danger"><?php echo e($selldata->sof_comment); ?></p>
    <?php endif; ?>

    <?php if(isset($selldata->lerms_letter_status) && ($selldata->lerms_letter_status == 2 || $selldata->lerms_letter_status == 3) && ($travel_type == 2 || $travel_type == 6)): ?>
        <!-- <div class="col-md-12">
            <div class="form-attach-file border-top pt-1 pb-1">
        ...
        <div class="form-attach-file border-bottom border-top pt-1 pb-1 mt-1 ">
            <label class="form-attach-label row mb-1" for="lerms_letter2">
                <div class="text-dark fw-bold">Lerms Letter
                    ...
                    <?php if($selldata->lerms_letter_status == 2): ?>
                    <span class="text-danger">*</span>
                <?php endif; ?>
        ...
        <p class="text-danger"><?php echo e($selldata->lerms_letter_comment); ?></p>
    <?php endif; ?>

    <?php if(isset($selldata->university_letter_status) && ($selldata->university_letter_status == 2 || $selldata->university_letter_status == 3) && $travel_type == 4): ?>
        <!-- <div class="col-md-12">
            <div class="form-attach-file border-top pt-1 pb-1">
        ...
        <div class="form-attach-file border-bottom border-top pt-1 pb-1 mt-1 ">
            <label class="form-attach-label row mb-1" for="university_letter2">
                <div class="text-dark fw-bold">University Lette
                    ...
                    <?php if($selldata->university_letter_status == 2): ?>
                    <span class="text-danger">*</span>
                <?php endif; ?>
        ...
        <p class="text-danger"><?php echo e($selldata->university_letter_comment); ?></p>
    <?php endif; ?>

    <?php if(isset($selldata->emp_letter_status) && ($selldata->emp_letter_status == 2 || $selldata->emp_letter_status == 3) && $travel_type == 3): ?>
        <!-- <div class="col-md-12">
            <div class="form-attach-file border-top pt-1 pb-1">
        ...
        <div class="form-attach-file border-bottom border-top pt-1 pb-1 mt-1 ">
            <label class="form-attach-label row mb-1" for="employment_letter2">
                <div class="text-dark fw-bold">Employment Letter
                    ...
                    <?php if($selldata->emp_letter_status == 2): ?>
                    <span class="text-danger">*</span>
        ...
        <p class="text-danger"><?php echo e($selldata->emp_letter_comment); ?></p>
    <?php endif; ?>
    <?php if(isset($selldata->emp_declaration_form_status) && ($selldata->emp_declaration_form_status == 2 || $selldata->emp_declaration_form_status == 3) && $travel_type == 3): ?>
        <!-- <div class="col-md-12">
            <div class="form-attach-file border-top pt-1 pb-1">
        ...
        <div class="form-attach-file border-bottom border-top pt-1 pb-1 mt-1 ">
            <label class="form-attach-label row mb-1" for="emp_declaration_form2">
                <div class="text-dark fw-bold">Employment Declaration Form
                    <?php if($selldata->emp_declaration_form_status == 2): ?>
                        <span class="text-danger">*</span>
                    <?php endif; ?>
        ...
        <p class="text-danger"><?php echo e($selldata->emp_declaration_form_comment); ?></p>
    <?php endif; ?>


    <?php if(isset($selldata->immigration_d_form_status) && ($selldata->immigration_d_form_status == 2 || $selldata->immigration_d_form_status == 3) && $travel_type == 5): ?>
        <!-- <div class="col-md-12">
            <div class="form-attach-file border-top pt-1 pb-1">
        ...
        <div class="form-attach-file border-bottom border-top pt-1 pb-1 mt-1 ">
            <label class="form-attach-label row mb-1" for="immigration_d_form2">
                <div class="text-dark fw-bold">Immigration Declaration form
                    ...
                    <?php if($selldata->immigration_d_form_status == 2): ?>
                    <span class="text-danger">*</span>
                 <?php endif; ?>
        ...
        <p class="text-danger"><?php echo e($selldata->immigration_d_form_comment); ?></p>
    <?php endif; ?>

    <?php if(isset($selldata->medical_letter_status) && ($selldata->medical_letter_status == 2 || $selldata->medical_letter_status == 3) && $travel_type == 6): ?>
        <!-- <div class="col-md-12">
            <div class="form-attach-file border-top pt-1 pb-1">
        ...
        <div class="form-attach-file border-bottom border-top pt-1 pb-1 mt-1 ">
            <label class="form-attach-label row mb-1" for="medical_letter2">
                <div class="text-dark fw-bold">Medical Letter
                    ...
                    <?php if($selldata->medical_letter_status == 2): ?>
                    <span class="text-danger">*</span>
                 <?php endif; ?>
        ...
        <p class="text-danger"><?php echo e($selldata->medical_letter_comment); ?></p>
    <?php endif; ?>

	  <?php if(isset($selldata->other_status) && ($selldata->other_status == 2 || $selldata->other_status == 3 )): ?>
        <div class="col-md-12">
        <div class="form-attach-file border-bottom border-top pt-1 pb-1 mt-1 ">
            ...
            <?php if($selldata->other_status == 2): ?>
            required
           <?php endif; ?>
        ...
        <p class="text-danger"><?php echo e($selldata->other_comment); ?></p>
    <?php endif; ?>

    <?php if(isset($selldata->surrender_letter_status) && ($selldata->surrender_letter_status == 2 || $selldata->surrender_letter_status == 3) && $selldata->surrender_letter != ''): ?>
        <div class="col-md-12">
            <div class="form-attach-file border-bottom border-top pt-1 pb-1 mt-1 ">
                ...
                <?php if($selldata->surrender_letter_status == 2): ?>
                required
               <?php endif; ?>
        ...
        <p class="text-danger"><?php echo e($selldata->surrender_letter_comment); ?></p>
    <?php endif; ?>

    <?php if(isset($selldata->refound_status) && ($selldata->refound_status == 2 || $selldata->refound_status == 3)): ?>
        <div class="col-md-12">
            <div class="form-attach-file border-bottom border-top pt-1 pb-1 mt-1 ">
        ...
        <p class="text-danger"><?php echo e($selldata->refound_comment); ?></p>
    <?php endif; ?>
...
<?php /**PATH /home/dataseed/prod-thomascook.dataseedtech.com/resources/views/agent/upload-rejected-doc.blade.php ENDPATH**/ ?>