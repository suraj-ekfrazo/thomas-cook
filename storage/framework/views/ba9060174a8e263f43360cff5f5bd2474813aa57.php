<script>
    $(function() {
	    ...
	    columns = [
            ...
            dataTable = callDataTable('data-datatable', '<?php echo route('under-process-request.data'); ?>', filters, columns, '', '',
                columnDefs);
    ...
    function exportExcel() {
        ...
        $.ajax({
            url: "<?php echo route('under-process-request.export'); ?>",
            type: 'POST',
...
<?php /**PATH /home/dataseed/prod-thomascook.dataseedtech.com/resources/views/stacks/js/modules/under-process-booking-req/index.blade.php ENDPATH**/ ?>