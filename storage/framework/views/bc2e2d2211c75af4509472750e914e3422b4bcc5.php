...
<div class="input-group mb-3">
    <label class="input-group-text border-0 border-bottom " for="user_status"><img src="<?php echo e(asset('admin-assets/svg/6.svg')); ?>">
    </label>
...
<script>
    ...
    $('.save-data-form').submit(function(event) {
        ...
        if (status) {
            ...
            $.ajax({
                url: "<?php echo e(route('admin-users.save')); ?>",
                headers: {
                ...
                success: function(result) {
                    ...
                    if (result.type === 'SUCCESS') {
                        ...
                        $('.loading-icon').hide();
                        var redirectUrl = "<?php echo e(route('admin-users.index')); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dataseed/prod-thomascook.dataseedtech.com/Modules/AdminUsers/Resources/views/modal/add.blade.php ENDPATH**/ ?>