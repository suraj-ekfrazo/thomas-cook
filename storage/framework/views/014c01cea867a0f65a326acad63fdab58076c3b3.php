<script>
    $(function() {
        var
            ...
            dataTable = callDataTable('data-datatable', '<?php echo route('admin-incidents.sell-report'); ?>', filters, columns, '', '',
                columnDefs);
    ...
    function exportExcel() {
        ...
        $.ajax({
            url: "<?php echo route('admin-incidents.export-sell-report'); ?>",
            type: 'POST',
...
<?php /**PATH /home/dataseed/prod-thomascook.dataseedtech.com/resources/views/stacks/js/modules/admin-incidents/sell-report.blade.php ENDPATH**/ ?>