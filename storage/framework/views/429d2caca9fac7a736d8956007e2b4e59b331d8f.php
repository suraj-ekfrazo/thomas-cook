    ...
    <div class="modal-dialog  modal-lg modal-dialog-centered">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title fw-bold" style="color: #2565ab;">Update Agent</h5>
                    ...
                    <div class="col-lg-6 col-sm-6 mt-3 <?php echo e($errors->has('agent_code') ? 'has-error' : ''); ?>">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input name="agent_code" id="agent_code"
                                class="form-control border-0 border-bottom bg-transparent " type="text"
                                placeholder="Enter BPC Id" value="<?php echo e($data['agent_code']); ?>" autocomplete="off"
                                value="<?php echo e($data['agent_code']); ?>">
                    ...
                    <div class="col-lg-6 col-sm-6 mt-3 <?php echo e($errors->has('mudra_code') ? 'has-error' : ''); ?>">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input name="mudra_code" id="mudra_code"
                                class="form-control border-0 border-bottom bg-transparent " type="text"
                                placeholder="Enter Mudra Code" value="<?php echo e($data['mudra_code']); ?>" autocomplete="off"
                    ...
                    <div class="col-lg-6 col-sm-6 mt-3 <?php echo e($errors->has('sap_code') ? 'has-error' : ''); ?>">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input name="sap_code" id="sap_code"
                                class="form-control border-0 border-bottom bg-transparent " type="text"
                                placeholder="Enter SAP Code" value="<?php echo e($data['sap_code']); ?>" autocomplete="off"
                    ...
                    <div class="col-lg-6 col-sm-6 mt-3 <?php echo e($errors->has('buy_margin') ? 'has-error' : ''); ?>">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input name="buy_margin" id="buy_margin"
                                class="form-control border-0 border-bottom bg-transparent " step="0.01" type="number"
...
<?php /**PATH /home/dataseed/prod-thomascook.dataseedtech.com/Modules/Agent/Resources/views/modal/edit.blade.php ENDPATH**/ ?>