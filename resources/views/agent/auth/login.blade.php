      ...
      <div>
        ...
        <div class="col-12 col-sm-12 mt-5 p-0" style="width: 313px;">
          ...
          <div class="input-group mb-3">
            ...
            <input class="form-control border-0 border-bottom @error('user_name') is-invalid @enderror"
              value="{{ old('user_name') }}" required autocomplete="user_name" autofocus type="text" id="user_name"
        ...
        <div class="col-lg-12 col-sm-12 mt-4 p-0" style="width: 313px;">
          ...
          <div class="input-group mb-3">
            ...
            <input class="form-control border-0 border-bottom @error('password') is-invalid @enderror" required type="password" placeholder="Enter password" id="password" name="password">
          </div>
          @error('password')
          <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
        ...
        <div class="row">
          ...
          <div class="col pe-0 ms-4">
            ...
            @if (Route::has('password.request'))
                <a href="{{ route('forget.password.get') }}" style="color: #BE0000; font-size: 14px;">Forgot
                    Password?
                </a>
            @endif
          </div>
