                    ...
                    <div class="me-3">
                        <div class="single-person">
                            ...
                            <div class="text-center">
                                ...
                                <div class="row-font border-0 border-bottom">{{ number_format((float) $buy_rate, 2, '.', '') }}</div>
                                <div class="row-font1">{{ number_format((float) $final_rate, 2, '.', '') }}</div>
                            </div>
                        </div>
                    </div>
                @endforeach
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-4 col-sm-4 mt-3">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" id="firstName" name="firstName" class="form-control border-0 border-bottom p-2" placeholder="First Name" value="{{ $AgentData->first_name }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-sm-4 mt-3">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" id="lastName" name="lastName" class="form-control border-0 border-bottom p-2" placeholder="Last Name" value="{{ $AgentData->last_name }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-sm-4 mt-3">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" id="mobileNumber" name="mobileNumber" class="form-control border-0 border-bottom p-2" placeholder="Mobile Number" value="{{ $AgentData->mobile_number }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-sm-4 mt-3">
                                ...
                                <div class="input-group mb-3">
                                    <input type="email" id="email" name="email" class="form-control border-0 border-bottom p-2" placeholder="Email" value="{{ $AgentData->email }}" required disabled>
                                </div>
                            </div>
