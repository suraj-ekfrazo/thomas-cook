...
<script type="text/javascript" src="{{ asset('admin-assets/js/bootstrap.bundle.min.js') }}"></script>
<script src="{{ asset('admin-assets/js/17301e251b.js') }}" crossorigin="anonymous"></script>
...
<script type="text/javascript" src="{{ asset('admin-assets/js/dataTables.bootstrap5.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('admin-assets/js/dataTables.select.min.js') }}"></script>
