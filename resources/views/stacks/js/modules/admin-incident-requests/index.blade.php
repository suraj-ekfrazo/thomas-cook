<script>
    $(function() {
        var
            ...
            columnDefs = [{
...

                {
                    ...
                    render: function(data, type, full, meta) {
                        if (full.id) {
                            var id = full.id;
                            var routeUrl = '{{ url("admin-incident-requests/documents") }}/' + id;
            ...
            dataTable = callDataTable('data-datatable', '{!! route("admin-incident-requests.data") !!}', filters, columns, '', '',
                columnDefs);
    ...
    function exportExcel() {
        ...
        $.ajax({
            url: "{!! route('admin-incident-requests.export') !!}",
            type: 'POST',
