  ...
  <table class="table" style="width: 70%;text-align: center;margin: auto;border: 1px solid #ddd;    background-color: #6e99d0;
    color: white;margin-bottom: 25px;">
      ...
      <tr>
        ...
        <td style="text-align: left;border: 1px solid #ddd;width: 50%;text-align: center;padding:10px 15px;"><?php echo $data['sub_agent_name'] ?></td>
      </tr>
       <tr>
       ...
       <tr >
        ...
        <td style="text-align: left;border: 1px solid #ddd;width: 50%;text-align: center;padding:10px 15px;"><?php echo $data['sub_agent_code'] ?></td>
      </tr>
       <tr>
        <td style="text-align: left;border: 1px solid #ddd;width: 50%;text-align: center;padding:10px 15px;">Validity From</td>
        <td style="text-align: left;border: 1px solid #ddd;width: 50%;text-align: center;padding:10px 15px;"><?php echo $data['sub_agent_form'] ?></td>
      </tr>
       <tr>
        <td style="text-align: left;border: 1px solid #ddd;width: 50%;text-align: center;padding:10px 15px;">Validity Till</td>
        <td style="text-align: left;border: 1px solid #ddd;width: 50%;text-align: center;padding:10px 15px;"><?php echo $data['sub_agent_to'] ?></td>
      </tr>
      <tr>
        <td style="text-align: left;border: 1px solid #ddd;width: 50%;text-align: center;padding:10px 15px;">Buy Margin</td>
        <td style="text-align: left;border: 1px solid #ddd;width: 50%;text-align: center;padding:10px 15px;"><?php echo $data['sub_agent_buy'] ?></td>
      </tr>
       <tr>
        <td style="text-align: left;border: 1px solid #ddd;width: 50%;text-align: center;padding:10px 15px;">Sell Margin</td>
        <td style="text-align: left;border: 1px solid #ddd;width: 50%;text-align: center;padding:10px 15px;"><?php echo $data['sub_agent_sell'] ?></td>
      </tr>
       <tr>
        <td style="text-align: left;border: 1px solid #ddd;width: 50%;text-align: center;padding:10px 15px;">First Name</td>
        <td style="text-align: left;border: 1px solid #ddd;width: 50%;text-align: center;padding:10px 15px;"><?php echo $data['sub_agent_first_name'] ?></td>
      </tr>
      <tr>
        <td style="text-align: left;border: 1px solid #ddd;width: 50%;text-align: center;padding:10px 15px;">Last Name</td>
        <td style="text-align: left;border: 1px solid #ddd;width: 50%;text-align: center;padding:10px 15px;"><?php echo $data['sub_agent_last_name'] ?></td>
      </tr>
       <tr>
        <td style="text-align: left;border: 1px solid #ddd;width: 50%;text-align: center;padding:10px 15px;">Contact No.</td>
        <td style="text-align: left;border: 1px solid #ddd;width: 50%;text-align: center;padding:10px 15px;"><?php echo $data['sub_agent_contact'] ?></td>
      </tr>
       <tr>
        <td style="text-align: left;border: 1px solid #ddd;width: 50%;text-align: center;padding:10px 15px;">Email-Id</td>
        <td style="text-align: left;border: 1px solid #ddd;width: 50%;text-align: center;padding:10px 15px;color: #fff !important;"><?php echo $data['sub_agent_mail'] ?></td>
      </tr>
