        ...
        <div class="login">
                ...
                <div class="login-part">
                    ...
                    @if(Session::has('mailSend'))
                        <div class="alert alert-success alert-dismissible fade in">
                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                            <p>Your User Id And Password Send On your mail .Please Check Your Mail.</p>
                        </div>
                    @endif
           ...
           <!--              <img src="images/2-Website-Change-Password.png" alt="" class="img-responsive"> -->
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 right-side-new">
                        ...
                        <form method="post" action="{{URL::to('sendEmailForUserId')}}" class="login-form-part">
                            @csrf
                        ...
                        <div class="back-button"><a href="{{URL::to('/')}}"><i class="fas fa-long-arrow-alt-left"></i></a></div>
                    </div>
