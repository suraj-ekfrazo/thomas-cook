  ...
  <table class="table" style="width: 70%;text-align: center;margin: auto;border: 1px solid #ddd;    background-color: #6e99d0;
    color: white;margin-bottom: 25px;">
      ...
      <tr>
        ...
        <td style="text-align: left;border: 1px solid #ddd;width: 50%;text-align: center;padding:10px 15px;"><?php echo $data['admin_mail_id'] ?></td>
      </tr>
       <tr>
       ...
       <tr>
        ...
        <td style="text-align: left;border: 1px solid #ddd;width: 50%;text-align: center;padding:10px 15px;"><?php echo $email ?></td>
      </tr>
  </table>
</div>
