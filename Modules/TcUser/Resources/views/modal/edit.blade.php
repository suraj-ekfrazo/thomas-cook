        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row mt-3 bgc m-2">
                    ...
                    <div class="col-lg-6 col-sm-6 mt-3 {{ $errors->has('tc_type') ? 'has-error' : '' }}">
                        ...
                        @component('components.ajax-error', ['field' => 'tc_type'])
                        @endcomponent
                    </div>
                </div>
            </div>
