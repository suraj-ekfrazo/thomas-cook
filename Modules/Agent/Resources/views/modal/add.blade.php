    ...
    <div class="container">
        ...
        <div class="bg-white p-2 shadow" style="border-radius: 20px;  ">
            <div class="row mt-3 m-2">
                ...
                <div class="col-lg-4 col-sm-4 mt-3 {{ $errors->has('agent_code') ? 'has-error' : '' }}">
                    <label style="color: #ADAEB0; font-size: 14px; ">BPC ID</label>
                    <div class="input-group mb-3">
                        <span class="input-group-text bg-transparent border-0 border-bottom" id="basic-addon1"><img src="{{ asset('admin-assets/svg/popup/username.svg') }}">
                        </span>
                        <input name="agent_code" id="agent_code" class="form-control border-0 border-bottom bg-transparent " type="text" placeholder="Enter BPC Id" value="{{ old('agent_code') }}" autocomplete="off">

                        @component('components.ajax-error', ['field' => 'agent_code'])
                        @endcomponent
                    </div>
                </div>
                ...
                <!-- <div class="col-lg-4 col-sm-4 mt-3 {{ $errors->has('status') ? 'has-error' : '' }}">
                    ...
                    <div class="input-group mb-3">
                        <label class="input-group-text border-0 border-bottom " for="parent_agent"><img src="{{ asset('admin-assets/svg/travel agent/agent-code.svg') }}">
                        </label>
                        <select name="parent_agent" id="parent_agent" class="form-select fw-bold border-0 border-bottom pb-0 bg-transparent" id="parent_agent">
                            ...
                            <option value="{{ $parent->id }}">
                                {{ $parent->agent_key . '(' . $parent->user_name . ')' }}
                            </option>
                            @endforeach
                        </select>
                ...
                <div class="col-lg-4 col-sm-4 mt-3 {{ $errors->has('status') ? 'has-error' : '' }}">
                    ...
                    <div class="input-group mb-3">
                        <label class="input-group-text border-0 border-bottom " for="agent_status"><img src="{{ asset('admin-assets/svg/popup/status.svg') }}">
                        </label>
                ...
                <div class="col-lg-4 col-sm-4 mt-3 {{ $errors->has('date_of_joining') ? 'has-error' : '' }}">
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text bg-transparent border-0 border-bottom" id="basic-addon1"><img src="{{ asset('admin-assets/svg/18.svg') }}">
                        </span>
                        <input name="validity_from" id="validity_from" class="form-control border-0 border-bottom bg-transparent " type="text" placeholder="Enter Validity From" value="{{ old('validity_from') }}" autocomplete="off">
                ...
                <div class="col-lg-4 col-sm-4 mt-3 {{ $errors->has('validity_till') ? 'has-error' : '' }}">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input name="validity_till" id="validity_till" class="form-control border-0 border-bottom bg-transparent " type="text" placeholder="Enter Validity Till" value="{{ old('validity_till') }}" autocomplete="off">
                ...
                <div class="col-lg-4 col-sm-4 mt-3 {{ $errors->has('buy_margin') ? 'has-error' : '' }}">
                    <label style="color: #ADAEB0; font-size: 14px; " for="buy_margin">Buy Margin</label>
                    <div class="input-group mb-3">
                        <span class="input-group-text bg-transparent border-0 border-bottom" id="basic-addon1"><img src="{{ asset('admin-assets/svg/12.svg') }}">
                        </span>
                        <input name="buy_margin" id="buy_margin" class="form-control border-0 border-bottom bg-transparent " type="number" min="0" step="0.01" placeholder="Enter Buy Margin" value="{{ old('buy_margin') }}" autocomplete="off">
                        @component('components.ajax-error', ['field' => 'buy_margin'])
                        @endcomponent
                    </div>
                </div>
                <div class="col-lg-4 col-sm-4 mt-3 {{ $errors->has('sell_margin') ? 'has-error' : '' }}">
                    <label style="color: #ADAEB0; font-size: 14px;" for="sell_margin">Sell Margin</label>
                    <div class="input-group mb-3">
                        <span class="input-group-text bg-transparent border-0 border-bottom" id="basic-addon1"><img src="{{ asset('admin-assets/svg/12.svg') }}">
                        </span>
                        <input name="sell_margin" id="sell_margin" class="form-control border-0 border-bottom bg-transparent " type="number" min="0" step="0.01" placeholder="Enter Sell Margin" value="{{ old('sell_margin') }}" autocomplete="off">
                ...
                <div class="col-lg-4 col-sm-4 mt-3 {{ $errors->has('first_name') ? 'has-error' : '' }}">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input name="first_name" id="first_name" class="form-control border-0 border-bottom bg-transparent " type="text" placeholder="Enter First Name" autocomplete="off" value="{{ old('first_name') }}">
                ...
                <div class="col-lg-4 col-sm-4 mt-3 {{ $errors->has('last_name') ? 'has-error' : '' }}">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input name="last_name" id="last_name" class="form-control border-0 border-bottom bg-transparent " type="text" placeholder="Enter Last Name" autocomplete="off" value="{{ old('last_name') }}">
                ...
                <div class="col-lg-4 col-sm-4 mt-3 {{ $errors->has('mobile_number') ? 'has-error' : '' }}">
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text bg-transparent border-0 border-bottom" id="basic-addon1"><img src="{{ asset('admin-assets/svg/popup/contect.svg') }}">
                        </span>
                        <input name="mobile_number" id="mobile_number" class="form-control border-0 border-bottom bg-transparent " type="text" placeholder="Enter Mobile Number" autocomplete="off" maxlength="10" value="{{ old('mobile_number') }}">
                ...
                <div class="col-lg-4 col-sm-4 mt-3 {{ $errors->has('email') ? 'has-error' : '' }}">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input name="email" id="email" class="form-control border-0 border-bottom bg-transparent " type="email" placeholder="Enter Email" autocomplete="off" value="{{ old('email') }}">
                ...
                <div class="col-lg-4 col-sm-4 mt-3 {{ $errors->has('profile') ? 'has-error' : '' }}">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="file" id="profile" name="profile" class="form-control border-0 border-bottom bg-transparent" placeholder="Enter Confirm Password" value="{{ old('profile') }}">
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    if (result.type === 'SUCCESS') {
                        var redirectUrl = "{{ route('agent.index') }}";
