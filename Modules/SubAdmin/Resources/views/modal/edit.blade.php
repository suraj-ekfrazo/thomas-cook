                ...
                <div class="row mt-3 bgc m-2">
                    <div class="col-lg-6 col-sm-6 mt-3 {{ $errors->has('name') ? 'has-error' : '' }}">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" readonly name="name" id="name" class="form-control border-0 border-bottom bg-transparent" placeholder="Enter UserName" value="{{ $data['name'] }}">
                    ...
                    <div class="col-lg-6 col-sm-6 mt-3 {{ $errors->has('user_code') ? 'has-error' : '' }}">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" readonly name="user_code" id="user_code" class="form-control border-0 border-bottom bg-transparent" placeholder="Enter User Id" value="{{ $data['user_code'] }}">
                    ...
                    <div class="col-lg-6 col-sm-6 mt-3 {{ $errors->has('gender') ? 'has-error' : '' }}">
                        ...
                        <div class="input-group mb-3">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="gender" value="male" id="inlineRadio1" value="male" {{ $data['gender'] == 'male' ? 'checked' : '' }}>
                                <label class="form-check-label" for="inlineRadio1">Male</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="gender" value="female" id="inlineRadio2" value="female" {{ $data['gender'] == 'female' ? 'checked' : '' }}>
                    ...
                    <div class="col-lg-6 col-sm-6 mt-3 {{ $errors->has('user_mobile') ? 'has-error' : '' }}">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" id="user_mobile" name="user_mobile" class="form-control border-0 border-bottom bg-transparent" placeholder="Enter Mobile Number" value="{{ $data['user_mobile'] }}" maxlength="10">
                    ...
                    <div class="col-lg-6 col-sm-6 mt-3 {{ $errors->has('email') ? 'has-error' : '' }}">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="email" readonly id="email" name="email" class="form-control border-0 border-bottom bg-transparent" placeholder="Enter Email" value="{{ $data['email'] }}">
                    ...
                    <div class="col-lg-6 col-sm-6 mt-3 {{ $errors->has('user_profile') ? 'has-error' : '' }}">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="file" id="user_profile" name="user_profile" accept="image/png, image/jpeg" class="form-control border-0 border-bottom bg-transparent" value="{{ old('user_profile') }}">
