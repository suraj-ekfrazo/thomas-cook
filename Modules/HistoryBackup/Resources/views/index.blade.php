    ...
    <div style="background-image: url({{ asset('admin-assets/img/main_bg.jpg') }});">
        <div class="container">
            ...
            <div class="row pt-5 pb-5 justify-content-center">
                ...
                {{-- <div class="col-md-6 col-lg-4 col-sm-3">
                    <a href="{{ route('historybackup.index') }}">
                        <div class="widget-stat card bg-dashboard m-3 @if (request()->segment(1) == 'historybackup' && request()->segment(2) == '') active @endif ">
                            <div class="card-body ">
                                <div class="media">
                                    <span class="me-3">
                                        <img src="{{ asset('admin-assets/svg/dashboard/ic_rate_master.svg') }}">
                                    </span>
                                    <div class=" fw-bold"> History Backup List</div>
                                </div>
                            </div>
                        </div>
                    </a>
